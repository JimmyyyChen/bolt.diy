            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  {!chatStarted && (
                    <div className="flex flex-row flex-wrap items-center gap-1 space-x-1 min-w-0 overflow-x-auto pb-1">
                  ...
                  <div
                    className={classNames(
                      'relative shadow-xs border-bolt-elements-borderColor backdrop-blur rounded-lg',
                    )}
                  >
                    <textarea
                      ref={textareaRef}
